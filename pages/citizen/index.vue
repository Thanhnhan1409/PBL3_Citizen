        ...
        <h2>Thông tin cá nhân</h2>
          <div>
            <div>
              <div class="infor">
                ...
                <div class="infor-content">
                  <ul class="list-infor">
                    <li>Họ và tên: <span>{{listInfor.name}}</span></li>
                    <li>
                      Số CCCD:
                  ...
                  <ul class="list-infor">
                    ...
                    <li>
                      Quê quán:
                      <span>
                        {{listInfor.address+" "+ listInfor.location.quarter+" "+ listInfor.location.town+" "+ listInfor.location.district+" "+ listInfor.location.city}}</span
                      >
                    </li>
                    <li>
                      Email:
            ...
            <div class="crimiantion">
              ...
              <div class="crimimal-content">Nội dung: {{listInfor.criminalRecord}}</div>
            </div>
          </div>
      </div>
</template>
...
export default {
  ...
  methods:{
      gender(list) {
        if(list.gender === false)
          return this.genderEx = "nữ"
